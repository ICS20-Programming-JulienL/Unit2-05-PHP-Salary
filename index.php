...
<html lang="en-ca">
  ...
  <body>
    ...
    <form action="./results.php" method="post" target="result">
      ...
      <input type="number" id="hoursWorked" placeholder="Enter hours worked" name="hoursWorked"><br><br>
      <label for="hourlyRate">Hourly Rate</label>
      <input type="number" id="hourlyRate" placeholder="Enter your hourly rate" name="hourlyRate"><br><br>
